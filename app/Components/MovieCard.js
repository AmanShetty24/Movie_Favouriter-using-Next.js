...
export default function MovieCard({ movie }) {
  ...
  return (
    <>
      <div 
        className="w-[220px] h-[380px] bg-gray-100 rounded-lg shadow-lg p-4 flex flex-col space-y-4 overflow-hidden cursor-pointer hover:shadow-xl transition-all duration-300"
        onClick={openModal}
      >
